{
  ...
  "metadata": {
    "colab": {
      "name": "Copy of 01_hello_world.ipynb",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/jragresta/Ada/blob/main/Copy_of_01_hello_world.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "source": [
        "# Hello, World!\n",
        "\n",
        "A _Hello World_ program is the first program that people often write when exploring a new programming language. In this lesson we will write a hello world program in a _code block_ in this **Colab** notebook. Colab is Google's hosting of Jupyter Notebook, an open-source web application that allows us to create and share documents that contain live code, equations, visualizations, and narrative text. Uses for Jupyter Notebook include: data cleaning and transformation, numerical simulation, statistical modeling, data visualization, machine learning, and much more. Here we are using Colab and Jupyter Notebook to create an interactive _Intro to Python_ course."
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "We will provide solutions for some of the exercises in Ada Build - Introduction to Programming in Python in [repl.it](repl.it).\n",
        "\n",
